...
function App() {
  ...
  return (
    <div class={mode}>
      <div
        className={
          " flex flex-col bg-white text-black dark:bg-gray-900 dark:text-white "
        }
      >
        <div>
        ...
        <div className="flex-grow flex flex-col md:flex-row">
          <div className="flex-grow justify-center items-center">
            ...
            <div className="flex justify-end mt-3 mr-5 ">
              <button
                className={`px-6 py-2 rounded-lg bg-blue-500 text-white dark:bg-gray-300 dark:text-gray-900 border border-transparent hover:bg-opacity-75 focus:outline-none`}
                onClick={handleCode}
              >
                Run
              </button>
              <button
                className={`ml-4 p-2 rounded-full dark:text-gray-500 text-yellow-500 hover:bg-blue-600 dark:hover:bg-gray-700 focus:outline-none`}
                onClick={handleMode}
              >
                {mode === "dark" ? (
                  <svg
